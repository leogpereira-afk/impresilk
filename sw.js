...
const CACHE = 'impresilk-shell-v114';
...
const SHELL = [
  './', 'index.html', 'equipe.html', 'styles.css?v=v114',
  'config.js?v=v114', 'logo.js?v=v114', 'frases.js?v=v114', 'store.js?v=v114', 'auth.js?v=v114', 'operacao.js?v=v114', 'app.js?v=v114', 'casa.js?v=v114', 'performance.js?v=v114', 'equipe.js?v=v114',
  ...
  e.respondWith((async () => {
    try {
      ...
      /* ÚLTIMO RECURSO: o mesmo arquivo de outra versão.
         ...
         queda de rede basta), o HTML pode pedir `casa.js?v=v114` enquanto o
         cache só tem `?v=v114`. `caches.match` casa a URL inteira, então isso
