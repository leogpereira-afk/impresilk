...
const CACHE = 'impresilk-shell-v99';
...
const SHELL = [
  './', 'index.html', 'equipe.html', 'styles.css?v=v99',
  'config.js?v=v99', 'logo.js?v=v99', 'frases.js?v=v99', 'store.js?v=v99', 'auth.js?v=v99', 'operacao.js?v=v99', 'app.js?v=v99', 'casa.js?v=v99', 'equipe.js?v=v99',
  ...
  e.respondWith((async () => {
    try {
      ...
      /* ÚLTIMO RECURSO: o mesmo arquivo de outra versão.
         ...
         queda de rede basta), o HTML pode pedir `casa.js?v=v99` enquanto o
         cache só tem `?v=v99`. `caches.match` casa a URL inteira, então isso
