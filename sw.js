...
const CACHE = 'impresilk-shell-v108';
...
const SHELL = [
  './', 'index.html', 'equipe.html', 'styles.css?v=v108',
  'config.js?v=v108', 'logo.js?v=v108', 'frases.js?v=v108', 'store.js?v=v108', 'auth.js?v=v108', 'operacao.js?v=v108', 'app.js?v=v108', 'casa.js?v=v108', 'equipe.js?v=v108',
  ...
  e.respondWith((async () => {
    try {
      ...
      /* ÚLTIMO RECURSO: o mesmo arquivo de outra versão.
         ...
         queda de rede basta), o HTML pode pedir `casa.js?v=v108` enquanto o
         cache só tem `?v=v108`. `caches.match` casa a URL inteira, então isso
