...
const CACHE = 'impresilk-shell-v120';
...
const SHELL = [
  './', 'index.html', 'equipe.html', 'styles.css?v=v120',
  'config.js?v=v120', 'logo.js?v=v120', 'frases.js?v=v120', 'store.js?v=v120', 'auth.js?v=v120', 'operacao.js?v=v120', 'app.js?v=v120', 'casa.js?v=v120', 'performance.js?v=v120', 'relatorios-entregas.js?v=v120', 'equipe.js?v=v120',
  ...
  e.respondWith((async () => {
    try {
      ...
      /* ÚLTIMO RECURSO: o mesmo arquivo de outra versão.
         ...
         queda de rede basta), o HTML pode pedir `casa.js?v=v120` enquanto o
         cache só tem `?v=v120`. `caches.match` casa a URL inteira, então isso
