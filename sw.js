...
const CACHE = 'impresilk-shell-v102';
...
const SHELL = [
  './', 'index.html', 'equipe.html', 'styles.css?v=v102',
  'config.js?v=v102', 'logo.js?v=v102', 'frases.js?v=v102', 'store.js?v=v102', 'auth.js?v=v102', 'operacao.js?v=v102', 'app.js?v=v102', 'casa.js?v=v102', 'equipe.js?v=v102',
  ...
  e.respondWith((async () => {
    try {
      ...
      /* ÚLTIMO RECURSO: o mesmo arquivo de outra versão.
         ...
         queda de rede basta), o HTML pode pedir `casa.js?v=v102` enquanto o
         cache só tem `?v=v102`. `caches.match` casa a URL inteira, então isso
