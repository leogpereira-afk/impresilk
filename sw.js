...
const CACHE = 'impresilk-shell-v105';
...
const SHELL = [
  './', 'index.html', 'equipe.html', 'styles.css?v=v105',
  'config.js?v=v105', 'logo.js?v=v105', 'frases.js?v=v105', 'store.js?v=v105', 'auth.js?v=v105', 'operacao.js?v=v105', 'app.js?v=v105', 'casa.js?v=v105', 'equipe.js?v=v105',
  ...
  e.respondWith((async () => {
    try {
      ...
      /* ÚLTIMO RECURSO: o mesmo arquivo de outra versão.
         ...
         queda de rede basta), o HTML pode pedir `casa.js?v=v105` enquanto o
         cache só tem `?v=v105`. `caches.match` casa a URL inteira, então isso
