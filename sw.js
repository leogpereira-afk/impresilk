...
const CACHE = 'impresilk-shell-v112';
...
const SHELL = [
  './', 'index.html', 'equipe.html', 'styles.css?v=v112',
  'config.js?v=v112', 'logo.js?v=v112', 'frases.js?v=v112', 'store.js?v=v112', 'auth.js?v=v112', 'operacao.js?v=v112', 'app.js?v=v112', 'casa.js?v=v112', 'performance.js?v=v112', 'equipe.js?v=v112',
  ...
  e.respondWith((async () => {
    try {
      ...
      /* ÚLTIMO RECURSO: o mesmo arquivo de outra versão.
         ...
         queda de rede basta), o HTML pode pedir `casa.js?v=v112` enquanto o
         cache só tem `?v=v112`. `caches.match` casa a URL inteira, então isso
