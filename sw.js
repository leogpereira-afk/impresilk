...
const CACHE = 'impresilk-shell-v115';
...
const SHELL = [
  './', 'index.html', 'equipe.html', 'styles.css?v=v115',
  'config.js?v=v115', 'logo.js?v=v115', 'frases.js?v=v115', 'store.js?v=v115', 'auth.js?v=v115', 'operacao.js?v=v115', 'app.js?v=v115', 'casa.js?v=v115', 'performance.js?v=v115', 'equipe.js?v=v115',
  ...
  e.respondWith((async () => {
    try {
      ...
      /* ÚLTIMO RECURSO: o mesmo arquivo de outra versão.
         ...
         queda de rede basta), o HTML pode pedir `casa.js?v=v115` enquanto o
         cache só tem `?v=v115`. `caches.match` casa a URL inteira, então isso
