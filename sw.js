...
const CACHE = 'impresilk-shell-v97';
...
const SHELL = [
  './', 'index.html', 'equipe.html', 'styles.css?v=v97',
  'config.js?v=v97', 'logo.js?v=v97', 'frases.js?v=v97', 'store.js?v=v97', 'auth.js?v=v97', 'operacao.js?v=v97', 'app.js?v=v97', 'casa.js?v=v97', 'equipe.js?v=v97',
  ...
  e.respondWith((async () => {
    try {
      ...
      /* ÚLTIMO RECURSO: o mesmo arquivo de outra versão.
         ...
         queda de rede basta), o HTML pode pedir `casa.js?v=v97` enquanto o
         cache só tem `?v=v97`. `caches.match` casa a URL inteira, então isso
