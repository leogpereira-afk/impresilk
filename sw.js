...
const CACHE = 'impresilk-shell-v89';
...
const SHELL = [
  './', 'index.html', 'equipe.html', 'styles.css?v=v89',
  'config.js?v=v89', 'logo.js?v=v89', 'frases.js?v=v89', 'store.js?v=v89', 'auth.js?v=v89', 'operacao.js?v=v89', 'app.js?v=v89', 'casa.js?v=v89', 'equipe.js?v=v89',
  ...
  e.respondWith((async () => {
    try {
      ...
      /* ÚLTIMO RECURSO: o mesmo arquivo de outra versão.
         ...
         queda de rede basta), o HTML pode pedir `casa.js?v=v89` enquanto o
         cache só tem `?v=v89`. `caches.match` casa a URL inteira, então isso
