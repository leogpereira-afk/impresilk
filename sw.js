...
const CACHE = 'impresilk-shell-v84';
...
const SHELL = [
  './', 'index.html', 'equipe.html', 'styles.css?v=v84',
  'config.js?v=v84', 'logo.js?v=v84', 'frases.js?v=v84', 'store.js?v=v84', 'auth.js?v=v84', 'operacao.js?v=v84', 'app.js?v=v84', 'casa.js?v=v84', 'equipe.js?v=v84',
  ...
  e.respondWith((async () => {
    try {
      ...
      /* ÚLTIMO RECURSO: o mesmo arquivo de outra versão.
         ...
         queda de rede basta), o HTML pode pedir `casa.js?v=v84` enquanto o
         cache só tem `?v=v84`. `caches.match` casa a URL inteira, então isso
