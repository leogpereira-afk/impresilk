...
const CACHE = 'impresilk-shell-v107';
...
const SHELL = [
  './', 'index.html', 'equipe.html', 'styles.css?v=v107',
  'config.js?v=v107', 'logo.js?v=v107', 'frases.js?v=v107', 'store.js?v=v107', 'auth.js?v=v107', 'operacao.js?v=v107', 'app.js?v=v107', 'casa.js?v=v107', 'equipe.js?v=v107',
  ...
  e.respondWith((async () => {
    try {
      ...
      /* ÚLTIMO RECURSO: o mesmo arquivo de outra versão.
         ...
         queda de rede basta), o HTML pode pedir `casa.js?v=v107` enquanto o
         cache só tem `?v=v107`. `caches.match` casa a URL inteira, então isso
