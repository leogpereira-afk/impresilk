...
const CACHE = 'impresilk-shell-v113';
...
const SHELL = [
  './', 'index.html', 'equipe.html', 'styles.css?v=v113',
  'config.js?v=v113', 'logo.js?v=v113', 'frases.js?v=v113', 'store.js?v=v113', 'auth.js?v=v113', 'operacao.js?v=v113', 'app.js?v=v113', 'casa.js?v=v113', 'performance.js?v=v113', 'equipe.js?v=v113',
  ...
  e.respondWith((async () => {
    try {
      ...
      /* ÚLTIMO RECURSO: o mesmo arquivo de outra versão.
         ...
         queda de rede basta), o HTML pode pedir `casa.js?v=v113` enquanto o
         cache só tem `?v=v113`. `caches.match` casa a URL inteira, então isso
