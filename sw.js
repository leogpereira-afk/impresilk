...
const CACHE = 'impresilk-shell-v104';
...
const SHELL = [
  './', 'index.html', 'equipe.html', 'styles.css?v=v104',
  'config.js?v=v104', 'logo.js?v=v104', 'frases.js?v=v104', 'store.js?v=v104', 'auth.js?v=v104', 'operacao.js?v=v104', 'app.js?v=v104', 'casa.js?v=v104', 'equipe.js?v=v104',
  ...
  e.respondWith((async () => {
    try {
      ...
      /* ÚLTIMO RECURSO: o mesmo arquivo de outra versão.
         ...
         queda de rede basta), o HTML pode pedir `casa.js?v=v104` enquanto o
         cache só tem `?v=v104`. `caches.match` casa a URL inteira, então isso
