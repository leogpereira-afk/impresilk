...
const CACHE = 'impresilk-shell-v121';
...
const SHELL = [
  './', 'index.html', 'equipe.html', 'styles.css?v=v121',
  'config.js?v=v121', 'logo.js?v=v121', 'frases.js?v=v121', 'store.js?v=v121', 'auth.js?v=v121', 'operacao.js?v=v121', 'app.js?v=v121', 'casa.js?v=v121', 'performance.js?v=v121', 'relatorios-entregas.js?v=v121', 'equipe.js?v=v121',
  ...
  e.respondWith((async () => {
    try {
      ...
      /* ÚLTIMO RECURSO: o mesmo arquivo de outra versão.
         ...
         queda de rede basta), o HTML pode pedir `casa.js?v=v121` enquanto o
         cache só tem `?v=v121`. `caches.match` casa a URL inteira, então isso
