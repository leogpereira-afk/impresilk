...
const CACHE = 'impresilk-shell-v111';
...
const SHELL = [
  './', 'index.html', 'equipe.html', 'styles.css?v=v111',
  'config.js?v=v111', 'logo.js?v=v111', 'frases.js?v=v111', 'store.js?v=v111', 'auth.js?v=v111', 'operacao.js?v=v111', 'app.js?v=v111', 'casa.js?v=v111', 'performance.js?v=v111', 'equipe.js?v=v111',
  ...
  e.respondWith((async () => {
    try {
      ...
      /* ÚLTIMO RECURSO: o mesmo arquivo de outra versão.
         ...
         queda de rede basta), o HTML pode pedir `casa.js?v=v111` enquanto o
         cache só tem `?v=v111`. `caches.match` casa a URL inteira, então isso
