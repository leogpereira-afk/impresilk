...
const CACHE = 'impresilk-shell-v92';
...
const SHELL = [
  './', 'index.html', 'equipe.html', 'styles.css?v=v92',
  'config.js?v=v92', 'logo.js?v=v92', 'frases.js?v=v92', 'store.js?v=v92', 'auth.js?v=v92', 'operacao.js?v=v92', 'app.js?v=v92', 'casa.js?v=v92', 'equipe.js?v=v92',
  ...
  e.respondWith((async () => {
    try {
      ...
      /* ÚLTIMO RECURSO: o mesmo arquivo de outra versão.
         ...
         queda de rede basta), o HTML pode pedir `casa.js?v=v92` enquanto o
         cache só tem `?v=v92`. `caches.match` casa a URL inteira, então isso
