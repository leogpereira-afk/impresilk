...
const CACHE = 'impresilk-shell-v94';
...
const SHELL = [
  './', 'index.html', 'equipe.html', 'styles.css?v=v94',
  'config.js?v=v94', 'logo.js?v=v94', 'frases.js?v=v94', 'store.js?v=v94', 'auth.js?v=v94', 'operacao.js?v=v94', 'app.js?v=v94', 'casa.js?v=v94', 'equipe.js?v=v94',
  ...
  e.respondWith((async () => {
    try {
      ...
      /* ÚLTIMO RECURSO: o mesmo arquivo de outra versão.
         ...
         queda de rede basta), o HTML pode pedir `casa.js?v=v94` enquanto o
         cache só tem `?v=v94`. `caches.match` casa a URL inteira, então isso
