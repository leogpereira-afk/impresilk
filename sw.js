...
const CACHE = 'impresilk-shell-v93';
...
const SHELL = [
  './', 'index.html', 'equipe.html', 'styles.css?v=v93',
  'config.js?v=v93', 'logo.js?v=v93', 'frases.js?v=v93', 'store.js?v=v93', 'auth.js?v=v93', 'operacao.js?v=v93', 'app.js?v=v93', 'casa.js?v=v93', 'equipe.js?v=v93',
  ...
  e.respondWith((async () => {
    try {
      ...
      /* ÚLTIMO RECURSO: o mesmo arquivo de outra versão.
         ...
         queda de rede basta), o HTML pode pedir `casa.js?v=v93` enquanto o
         cache só tem `?v=v93`. `caches.match` casa a URL inteira, então isso
