...
const CACHE = 'impresilk-shell-v96';
...
const SHELL = [
  './', 'index.html', 'equipe.html', 'styles.css?v=v96',
  'config.js?v=v96', 'logo.js?v=v96', 'frases.js?v=v96', 'store.js?v=v96', 'auth.js?v=v96', 'operacao.js?v=v96', 'app.js?v=v96', 'casa.js?v=v96', 'equipe.js?v=v96',
  ...
  e.respondWith((async () => {
    try {
      ...
      /* ÚLTIMO RECURSO: o mesmo arquivo de outra versão.
         ...
         queda de rede basta), o HTML pode pedir `casa.js?v=v96` enquanto o
         cache só tem `?v=v96`. `caches.match` casa a URL inteira, então isso
