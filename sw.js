...
const CACHE = 'impresilk-shell-v103';
...
const SHELL = [
  './', 'index.html', 'equipe.html', 'styles.css?v=v103',
  'config.js?v=v103', 'logo.js?v=v103', 'frases.js?v=v103', 'store.js?v=v103', 'auth.js?v=v103', 'operacao.js?v=v103', 'app.js?v=v103', 'casa.js?v=v103', 'equipe.js?v=v103',
  ...
  e.respondWith((async () => {
    try {
      ...
      /* ÚLTIMO RECURSO: o mesmo arquivo de outra versão.
         ...
         queda de rede basta), o HTML pode pedir `casa.js?v=v103` enquanto o
         cache só tem `?v=v103`. `caches.match` casa a URL inteira, então isso
