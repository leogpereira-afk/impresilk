...
const CACHE = 'impresilk-shell-v86';
...
const SHELL = [
  './', 'index.html', 'equipe.html', 'styles.css?v=v86',
  'config.js?v=v86', 'logo.js?v=v86', 'frases.js?v=v86', 'store.js?v=v86', 'auth.js?v=v86', 'operacao.js?v=v86', 'app.js?v=v86', 'casa.js?v=v86', 'equipe.js?v=v86',
  ...
  e.respondWith((async () => {
    try {
      ...
      /* ÚLTIMO RECURSO: o mesmo arquivo de outra versão.
         ...
         queda de rede basta), o HTML pode pedir `casa.js?v=v86` enquanto o
         cache só tem `?v=v86`. `caches.match` casa a URL inteira, então isso
