...
const CACHE = 'impresilk-shell-v95';
...
const SHELL = [
  './', 'index.html', 'equipe.html', 'styles.css?v=v95',
  'config.js?v=v95', 'logo.js?v=v95', 'frases.js?v=v95', 'store.js?v=v95', 'auth.js?v=v95', 'operacao.js?v=v95', 'app.js?v=v95', 'casa.js?v=v95', 'equipe.js?v=v95',
  ...
  e.respondWith((async () => {
    try {
      ...
      /* ÚLTIMO RECURSO: o mesmo arquivo de outra versão.
         ...
         queda de rede basta), o HTML pode pedir `casa.js?v=v95` enquanto o
         cache só tem `?v=v95`. `caches.match` casa a URL inteira, então isso
