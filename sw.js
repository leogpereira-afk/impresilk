...
const CACHE = 'impresilk-shell-v85';
...
const SHELL = [
  './', 'index.html', 'equipe.html', 'styles.css?v=v85',
  'config.js?v=v85', 'logo.js?v=v85', 'frases.js?v=v85', 'store.js?v=v85', 'auth.js?v=v85', 'operacao.js?v=v85', 'app.js?v=v85', 'casa.js?v=v85', 'equipe.js?v=v85',
  ...
  e.respondWith((async () => {
    try {
      ...
      /* ÚLTIMO RECURSO: o mesmo arquivo de outra versão.
         ...
         queda de rede basta), o HTML pode pedir `casa.js?v=v85` enquanto o
         cache só tem `?v=v85`. `caches.match` casa a URL inteira, então isso
