...
const CACHE = 'impresilk-shell-v119';
...
const SHELL = [
  './', 'index.html', 'equipe.html', 'styles.css?v=v119',
  'config.js?v=v119', 'logo.js?v=v119', 'frases.js?v=v119', 'store.js?v=v119', 'auth.js?v=v119', 'operacao.js?v=v119', 'app.js?v=v119', 'casa.js?v=v119', 'performance.js?v=v119', 'relatorios-entregas.js?v=v119', 'equipe.js?v=v119',
  ...
  e.respondWith((async () => {
    try {
      ...
      /* ÚLTIMO RECURSO: o mesmo arquivo de outra versão.
         ...
         queda de rede basta), o HTML pode pedir `casa.js?v=v119` enquanto o
         cache só tem `?v=v119`. `caches.match` casa a URL inteira, então isso
